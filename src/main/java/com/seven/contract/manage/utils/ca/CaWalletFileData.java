...
public class CaWalletFileData {
    private Crypto crypto;
    private String id;
    private int version;


    public CaWalletFileData() {
    }
    ...
    public static class Crypto {
        ...
        @JsonTypeInfo(
                ...
                property = "kdf")
        @JsonSubTypes({
                @JsonSubTypes.Type(value = Aes128CtrKdfParams.class, name = "pbkdf2"),
    ...
    public static class KdfParamsDeserialiser extends JsonDeserializer<KdfParams> {
